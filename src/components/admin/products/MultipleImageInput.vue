...
<template>
    <div>
        <label ref="dropZone" for="details['images']" class="relative flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100" @mouseover="() => { showPopover = true; }" @mouseleave="() => { showPopover = false; }">
            <input ref="fileInput" @change="handleFileChange()" type="file" id="details['images']" accept=".webp" multiple class="hidden">
